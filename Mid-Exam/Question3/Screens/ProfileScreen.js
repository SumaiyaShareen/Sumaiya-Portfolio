...
import { StyleSheet, View, Text, ScrollView, Switch, TouchableOpacity, Image } from 'react-native';
    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.settingsSection}>
        ...
        <View style={styles.settingItem}>
          <Text style={styles.settingText}>Favourites</Text>
          <Switch
...
const styles = StyleSheet.create({
  ...
  profileHeader: {
    alignItems: 'center',
    marginBottom: 20,
    backgroundColor: '#6200ee', // Purple background for header
    padding: 20,
    borderRadius: 10,
  },
  profileImage: {
  ...
  editButton: {
    backgroundColor: '#03dac6', // Teal button color
    borderRadius: 20,
  ...
  sectionTitle: {
    ...
    fontWeight: 'bold',
    marginBottom: 10,
    color: '#6200ee', // Purple text for section titles
  },
  settingItem: {
    flexDirection: 'row',
    justifyContent: 'space-between',
